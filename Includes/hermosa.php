...
<head>
    ...
    <link rel="stylesheet" href="../CSSFiles/hermosa.css">
</head>
<body>
<?php
    include("header.php");
    ?>
    <section class="hermosa" id="hermosa">
    <div class="container p-4">
        <div class="links mb-3">
            ...
            <a href="" class="text-dark text-decoration-none fs-4 text-uppercase">hermosa
            </a>
        </div>
        <div class="row section-heading mb-3">
            <h1 class="main-heading text-center  fw-light text-dark text-uppercase mt-5 mb-5"><span>hermosa</span></h1>
   ...
   <div class="col-md-4 col-sm-6 mb-4 position-relative">
    ...
    <div class="text">
        <h3 class="text-uppercase fs-4 mt-2 mb-2">hermosa h-01 </h3>
   ...
   <div class="col-md-4 col-sm-6 mb-4 position-relative">
    ...
    <div class="text">
        <h3 class="text-uppercase fs-4 mt-2 mb-2">hermosa h-02</h3>
        <p class="text-uppercase fs-3 text-secondary mb-4"><span class="text-decoration-line-through">rs 5700.00  </span><sub class="text-dark text-decoration-underline fs-3 fw-bold"> RS4,845.00</sub></p>
   ...
   <div class="col-md-4 col-sm-6 mb-4 position-relative">
    ...
    <div class="text">
        <h3 class="text-uppercase fs-4 mt-2 mb-2">hermosa h-03</h3>
        <p class="text-uppercase fs-3 text-secondary mb-4"><span class="text-decoration-line-through">rs 5700.00  </span><sub class="text-dark text-decoration-underline fs-3 fw-bold"> RS4,845.00</sub></p>
        <a href="" class="cart text-white text-decoration-none text-capitalize fs-3 fw-light">read more...</a>
    </div>
    <a href="#" class="sale">Sale!</a>
   ...
   <div class="col-md-4 col-sm-6 mb-4 position-relative">
    ...
    <div class="text">
        <h3 class="text-uppercase fs-4 mt-2 mb-2"hermosa h--0d</h3>
   ...
   <div class="col-md-4 col-sm-6 mb-4 position-relative">
    ...
    <div class="text">
        <h3 class="text-uppercase fs-4 mt-2 mb-2">hermosa h-07</h3>
        <p class="text-uppercase fs-3 text-secondary mb-4"><span class="text-decoration-line-through">rs 5700.00  </span><sub class="text-dark text-decoration-underline fs-3 fw-bold"> RS4,845.00</sub></p>
        <a href="" class="cart text-white text-decoration-none text-capitalize fs-3 fw-light">read more...</a>
    </div>
    <a href="#" class="sale">Sale!</a>
   ...
   <div class="col-md-4 col-sm-6 mb-4 position-relative">
    ...
    <div class="text">
        <h3 class="text-uppercase fs-4 mt-2 mb-2">hermosa h-08</h3>
        <p class="text-uppercase fs-3 text-secondary mb-4"><span class="text-decoration-line-through">rs 5700.00  </span><sub class="text-dark text-decoration-underline fs-3 fw-bold"> RS4,845.00</sub></p>
        <a href="" class="cart text-white text-decoration-none text-capitalize fs-3 fw-light">read more...</a>
    </div>
    <a href="#" class="sale">Sale!</a>
   ...
   <div class="col-md-4 col-sm-6 mb-4 position-relative">
    ...
    <div class="text">
        <h3 class="text-uppercase fs-4 mt-2 mb-2">hermosa h-09</h3>
        <p class="text-uppercase fs-3 text-secondary mb-4"><span class="text-decoration-line-through">rs 5700.00  </span><sub class="text-dark text-decoration-underline fs-3 fw-bold"> RS4,845.00</sub></p>
        <a href="" class="cart text-white text-decoration-none text-capitalize fs-3 fw-light">read more...</a>
    </div>
    <a href="#" class="sale">Sale!</a>
   ...
   <div class="col-md-4 col-sm-6 mb-4 position-relative">
    ...
    <div class="text">
        <h3 class="text-uppercase fs-4 mt-2 mb-2">hermosa h-10</h3>
        <p class="text-uppercase fs-3 text-secondary mb-4"><span class="text-decoration-line-through">rs 5700.00  </span><sub class="text-dark text-decoration-underline fs-3 fw-bold"> RS4,845.00</sub></p>
        <a href="" class="cart text-white text-decoration-none text-capitalize fs-3 fw-light">read more...</a>
    </div>
    <a href="#" class="sale">Sale!</a>
